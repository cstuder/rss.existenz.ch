...
class HauptstadtBeBridge extends BridgeAbstract
{
     ...
     * 2. In der Netzwerkkonsole den POST-Request auf api-hauptstadt.wepublish.media mit der grössten Antwort suchen. (Benötigt `data.page.blocks`)
     * 3. Rechtsklick -> Copy -> Copy POST data
     * 4. JSON in single quotes unten als CURLOPT_POSTFIELDS eintragen.
     * 5. Cache-Dauer wieder auf 600 setzen.
     */
    protected function readIndexPage()
    {
        ...
        curl_setopt_array($curl, [
            CURLOPT_URL => "https://api-hauptstadt.wepublish.media/v1",
